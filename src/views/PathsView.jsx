  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', background: 'var(--surface-page)', padding: isMobile ? '28px 16px' : '48px 32px' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <div style={{ position: 'relative', borderLeft: '2px solid var(--border)', marginLeft: isMobile ? 12 : 24,
          display: 'flex', flexDirection: 'column', gap: 36 }}>
          {steps.map((s, i) => (
            <div key={i} style={{ position: 'relative', paddingLeft: isMobile ? 32 : 48 }}>
              ...
              <div style={{ background: 'var(--surface-card)', border: '1px solid var(--border)',
                borderRadius: 'var(--radius-xl)', boxShadow: 'var(--shadow-sm)', padding: isMobile ? 16 : 22 }}>
